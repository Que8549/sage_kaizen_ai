...
#     """
#     Dedupe strategy:
#       - Store 'content_hash' in metadata for chunk 0 (and we also store it on all chunks).
#       - On re-run, compare content_hash; if unchanged, skip embedding + DB writes.
#     """
#     sql = """
...
# -----------------------------
# DB helpers: dedupe + batch upsert
# -----------------------------
